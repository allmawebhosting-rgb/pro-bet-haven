...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A private members' platform for carefully researched football predictions. Join a curated channel and receive premium insights." },
      { property: "og:title", content: "Aurum — Premium Sports Predictions" },
      { property: "og:description", content: "Carefully researched football predictions for a private, invite-only members' circle." },
