...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Aurum Fixed — 100% Guaranteed Fixed Matches, Delivered Daily" },
      { name: "twitter:description", content: "Insider fixed matches with verified sources. Claim 2 free picks — no stake, no risk. Join the private VIP circle winning every day." },
